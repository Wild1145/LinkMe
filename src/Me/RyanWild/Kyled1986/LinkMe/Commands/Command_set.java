    ...
    public boolean run(CommandSender commandSender, Command command, String commandLabel, String[] args)
        ...
        if (Strings.TwitchStatus.equalsIgnoreCase("true"))
         ...
         if (args[0].equalsIgnoreCase("set"))
            ...
            else if (args[1].equalsIgnoreCase("donatordescription")) {
            ...
            if (args[0].equalsIgnoreCase("forumsdescription")) {
                Linkme.messages.set("Forums.info.url", args[1]);
                Linkme.messages.save();
            ...
            if (args[0].equalsIgnoreCase("mumbledescription")) {
            ...
            if (args[0].equalsIgnoreCase("twitterdescription")) {
                Linkme.messages.set("twitter.info.url", args[1]);
                Linkme.messages.save();
            ...
            if (args[0].equalsIgnoreCase("VoteLink02url")) {
            ...
            if (args[0].equalsIgnoreCase("VoteLink04url")) {
