...
public class Command_byoutube extends BukkitCommand
    ...
    public boolean run(CommandSender commandSender, Command command, String commandLabel, String[] args)
        ...
        if (LinkMe_Strings.YoutubeStatus.equalsIgnoreCase("true"))
            {
            Bukkit.broadcastMessage(LinkMe_Utils.replaceColors(LinkMe_Strings.Announcer) + ": " + LinkMe_Utils.replaceColors(LinkMe_Strings.Youtubedescription) + ": " + LinkMe_Utils.replaceColors(LinkMe_Strings.Youtubeurl));
            }
        else
            {
