...
public class Command_site extends BukkitCommand
    ...
    public boolean run(CommandSender commandSender, Command command, String commandLabel, String[] args)
        ...
        if (LinkMe_Strings.WebsiteStatus.equalsIgnoreCase("true"))
            {
            player.sendMessage(LinkMe_Utils.replaceColors(LinkMe_Strings.Announcer) + ": " + LinkMe_Utils.replaceColors(LinkMe_Strings.Websitedescription) + ": " + LinkMe_Utils.replaceColors(LinkMe_Strings.Websiteurl));
            }
        else
            {
