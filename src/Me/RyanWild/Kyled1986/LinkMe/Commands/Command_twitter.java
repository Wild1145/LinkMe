...
@CommandPermissions(source = SourceType.PLAYER, permission = "linkme.twitter")
public class Command_twitter extends BukkitCommand
    ...
    public boolean run(CommandSender commandSender, Command command, String commandLabel, String[] args)
        ...
        if (LinkMe_Strings.TwitterStatus.equalsIgnoreCase("true"))
            {
            player.sendMessage(LinkMe_Utils.replaceColors(LinkMe_Strings.Announcer) + ": " + LinkMe_Utils.replaceColors(LinkMe_Strings.Twitchdescription) + ": " + LinkMe_Utils.replaceColors(LinkMe_Strings.Twitterurl));
            }
        else
            {
