...
public class Command_facebook extends BukkitCommand
    ...
    public boolean run(CommandSender commandSender, Command command, String commandLabel, String[] args)
        ...
        if (LinkMe_Strings.FacebookStatus.equalsIgnoreCase("true"))
            {
            player.sendMessage(LinkMe_Utils.replaceColors(LinkMe_Strings.Announcer) + ": " + LinkMe_Utils.replaceColors(LinkMe_Strings.FacebookStatus) + ": " + LinkMe_Utils.replaceColors(LinkMe_Strings.Facebookurl));
            }
        else
            {
