...
public class Command_donator extends BukkitCommand
    ...
    public boolean run(CommandSender commandSender, Command command, String commandLabel, String[] args)
        ...
        if (LinkMe_Strings.Donatorstatus.equalsIgnoreCase("true"))
            {
            player.sendMessage(LinkMe_Utils.replaceColors(LinkMe_Strings.Announcer) + ": " + LinkMe_Utils.replaceColors(LinkMe_Strings.Donatordescription) + ": " + LinkMe_Utils.replaceColors(LinkMe_Strings.Donatorurl));
            }
        else
            {
