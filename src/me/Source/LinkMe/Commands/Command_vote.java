...
public class Command_vote extends BukkitCommand
{
    ...
    Player player = (Player) commandSender;
         if (Strings.VoteStatus.equalsIgnoreCase("true")){
            player.sendMessage(LinkMe_Utils.replaceColors(Strings.Announcer) + ": " + LinkMe_Utils.replaceColors(Strings.Votedescription) + " "+ LinkMe_Utils.replaceColors(Strings.Voteurl));
        } else {
